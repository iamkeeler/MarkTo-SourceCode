...
class InlineProcessor {
    ...
    private func processBold(in attributedString: NSMutableAttributedString, baseFont: NSFont) {
        ...
        // Then process __ bold __ (update string after first processing)
        let updatedString = attributedString.string
        let updatedRange = NSRange(location: 0, length: updatedString.count)
