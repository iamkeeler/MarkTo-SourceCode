...
struct SettingsView: View {
    ...
    @State private var showingFormattingView = false
    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                // Rich Text Formatting Button
                LabeledContent("Rich Text Formatting") {
                    Button {
                        showingFormattingView = true
                    } label: {
                        HStack(spacing: 8) {
                            Text("Customize Formatting")
                                .foregroundStyle(.primary)
        ...
        .sheet(isPresented: $showingFormattingView) {
